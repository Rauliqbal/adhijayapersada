...
<template>
   <div
      class="bg-[url('https://images.unsplash.com/photo-1616661317985-aeb2a13016d6?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1169&q=80')] bg-no-repeat bg-center bg-cover h-[80vh] flex flex-col justify-center relative mt-[80px]"
   >
