   ...
   <section class="container">
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
         <div>
            ...
            <p class="paragraph mt-4"><span class="font-semibold">CV. ADHI JAYA PERSADA</span> berkomitmen membangun reputasi yang nyata dengan menyediakan layanan profesional dan invatif untuk customer di seluruh Indonesia.</p>
         </div>
         <div>
